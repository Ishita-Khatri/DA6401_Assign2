Part B involves fine-tuning a pre-trained model on the iNaturalist dataset. I use **ResNet50** as the pre-trained model. The file `Assign2B.ipynb` contains the code to:
